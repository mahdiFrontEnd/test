...
import ShowTopTable from './show/ShowTopTable';
import { setItems } from '../../../../store/inventoryRequest/InventoryRequest2';
// import MoreDataShow from './show/MoreDataShow';
...
const InventorySingle2 = ({ address, pageType, linkAddress, title }) => {
  ...
  return (
    <div>
      ...
      <ShowItems address={address} pageType={pageType}/>
      {pageType === 'show' && (
        <>
          <LastStatuses data={data.last_statuses} />
          {/*<MoreDataShow />*/}
        </>
      )}
    </div>
