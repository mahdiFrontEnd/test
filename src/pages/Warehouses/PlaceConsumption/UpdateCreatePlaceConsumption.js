...
const UpdateCreatePlaceConsumption = ({ rowData }) => {
  ...
  const onFinish = (values) => {
    ...
    }).updateCreatePlaceConsumption(values, rowData ? 'put' : 'post', rowData?.id);
  };
  ...
  return (
    <>
      ...
      <Modal
        width={900}
        open={open}
        title={`${rowData ? 'ویرایش' : 'ایجاد'}  موارد مصرف `}
...
export default UpdateCreatePlaceConsumption;
